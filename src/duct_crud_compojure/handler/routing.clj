(ns duct-crud-compojure.handler.routing
  (:use [hiccup.core]
  ...
  (:require
            ...
            [duct-crud-compojure.boundary.users :as db.users]
            [duct-crud-compojure.spec.user :as s.user]
...
(defmethod ig/init-key :duct-crud-compojure.handler/routing [_ {:keys [db]}]
　(routes
